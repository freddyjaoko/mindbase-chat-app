    ...
    <div className="flex flex-col h-full w-full bg-background p-6 overflow-hidden">
      <div className="flex justify-between items-center mb-8 border-b-2 border-black pb-4">
        ...
        <div className="flex items-center gap-4">
          <ModelSelector currentModel={profile.insightModel || "gpt-4o"} models={ALL_VALID_MODELS} slug={slug} />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        {briefing ? (
          <div className="bg-card border-2 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
            ...
            <Markdown className="markdown text-lg leading-relaxed">{briefing.content}</Markdown>
          </div>
        ) : (
